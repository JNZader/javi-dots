...
import type { SetupStep, TelemetryMode } from '../types/index.js'
import { runTelemetry } from '../orchestrator/telemetry.js'
...
export default function Telemetry({ mode }: TelemetryProps) {
  ...
  return (
    <Box flexDirection="column" padding={1}>
      <Box marginBottom={1}>
        ...
        <Text> telemetry {mode !== 'summary' ? mode : ''}</Text>
      </Box>
      {steps.map(s => (
